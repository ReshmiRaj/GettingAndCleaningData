...
# Version 1.0
---
The following files are of interest in the zip file provided
---
...
* Get the data file from the     URLhttp://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
* This data file contains test and train data.
* Merge the test data and train data.
* Specify the activity name based on the activity_labels.txt
* Once the data is merged, from the complete data set, select only those columns that provide mean and standard deviation.
